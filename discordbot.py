...
klist={'威圧':30, '言いくるめ':5, '医学':1, '運転':55, '応急手当':50, 'オカルト':5, '隠密':20, '回避':0, '科学':1, '鍵開け':1, '鑑定':5, '機械修理':50, '聞き耳':20, '近接戦闘':75, 'クトゥルフ神話':11, '芸術':5, '経理':5, '考古学':1, 'コンピューター':5, 'サバイバル':50, '自然':10, '拳銃':20, 'ライフル':25, 'ショットガン':25, '重機械操作':1, '信用':0, '心理学':50, '人類学':1, '水泳':20, '精神分析':1, '説得':10, '操縦':1, '跳躍':20, '追跡':10, '手さばき':10, '電気修理':10, '電子工学':1, '投擲':20, '登攀':20, '図書館':20, 'ナビゲート':10, '変装':5, '法律':85, '母国語':0, '魅惑':15, '目星':75, '歴史':65}
