...
dlist={'威圧':15, '言いくるめ':5, '医学':1, '運転':20, '応急手当':30, 'オカルト':5, '隠密':20, '回避':0, '科学':1, '鍵開け':1, '鑑定':5, '機械修理':10, '聞き耳':20, '近接戦闘':25, 'クトゥルフ神話':0, '芸術':5, '経理':5, '考古学':1, 'コンピューター':5, 'サバイバル':10, '自然':10, '拳銃':20, 'ライフル':25, 'ショットガン':25, '重機械操作':1, '信用':0, '心理学':10, '人類学':1, '水泳':20, '精神分析':1, '説得':10, '操縦':1, '跳躍':20, '追跡':10, '手さばき':10, '電気修理':10, '電子工学':1, '投擲':20, '登攀':20, '図書館':20, 'ナビゲート':10, '変装':5, '法律':5, '母国語':0, '魅惑':15, '目星':25, '歴史':5}
